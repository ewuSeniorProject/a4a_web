                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse form-group" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: establishmentVM.establishmentList">
                                    <div class="table-row-color">
                                        <div class="col-6"><label for="name"> Name: </label><input class="form-control" id="name" data-bind="value: name, hasfocus: name.focused"></div>
                                        <div class="col-6"><label for="website"> Website: </label><input class="form-control" id="website" data-bind="value: website, hasfocus: website.focused"></div>
                                    </div>
                                    <div class="table-row-color">
                                    ...
                                    <div class="table-row-color">
                                        <div class="col-4"><label for="contact_fname"> First Name: </label><input class="form-control" id="contact_fname" data-bind="value: contact_fname, hasfocus: contact_fname.focused"></div>
                                        <div class="col-4"><label for="contact_lname"> Last Name: </label><input class="form-control" id="contact_lname" data-bind="value: contact_lname, hasfocus: contact_lname.focused"></div>
                                        <div class="col-4"><label for="contact_title"> Title: </label><input class="form-control" id="contact_title" data-bind="value: contact_title, hasfocus: contact_title.focused"></div>
                                    </div>
                                    <div class="table-row-color">
                                        ...
                                        <div class="col-4"><label for="date"> Survey Date: </label><input class="form-control" id="date" data-bind="value: date, hasfocus: date.focused"></div>
                                    </div>
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse form-group" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: parkingVM.parkingList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse form-group" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: routeFromParkingVM.routeFromParkingList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFour" class="collapse form-group" aria-labelledby="headingFour" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: passengerLoadingVM.passengerLoadingList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFive" class="collapse form-group" aria-labelledby="headingFive" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: staBusVM.staBusList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSix" class="collapse form-group" aria-labelledby="headingSix" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: exteriorPathwayVM.exteriorPathwayList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeven" class="collapse form-group" aria-labelledby="headingSeven" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: exteriorStairsVM.exteriorStairsList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseEight" class="collapse form-group" aria-labelledby="headingEight" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: exteriorRampsVM.exteriorRampsList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseNine" class="collapse form-group" aria-labelledby="headingNine" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: mainEntranceVM.mainEntranceList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTen" class="collapse form-group" aria-labelledby="headingTen" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: interiorVM.interiorList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseEleven" class="collapse form-group" aria-labelledby="headingEleven" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: elevatorVM.elevatorList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwelve" class="collapse form-group" aria-labelledby="headingTwelve" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: signageVM.signageList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThirteen" class="collapse form-group" aria-labelledby="headingThirteen" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: emergencyVM.emergencyList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFourteen" class="collapse form-group" aria-labelledby="headingFourteen" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: seatingVM.seatingList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseFifteen" class="collapse form-group" aria-labelledby="headingFifteen" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: restroomVM.restroomList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSixteen" class="collapse form-group" aria-labelledby="headingSixteen" data-parent="#accordion">
                                <div class="card-body card-body-color" data-bind="foreach: restroomInfoVM.restroomInfoList">
                                    <div class="table-row-color">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSeventeen" class="collapse form-group" aria-labelledby="headingSeventeen" data-parent="#accordion">
                                <div d="communication" class="card-body card-body-color" data-bind="foreach: communicationVM.communicationList">
                                    <div class="table-row-color">
